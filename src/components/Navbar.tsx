...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {mobileMenuOpen && (
        <div className="absolute top-0 left-0 w-full bg-[#414652]/80 backdrop-blur-sm rounded-2xl shadow-md border-t border-[#5a5f70] px-6 py-5 z-40 transition-all duration-300 ease-in-out">
